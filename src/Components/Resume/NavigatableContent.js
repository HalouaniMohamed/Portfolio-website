...
const NavigatableContent = () => {
    return (
        <div className="overflow-y-hidden h-96  w-fit pl-3" id="resumeContent">
            ...
            <div className="h-96 w-9/12 space-y-4">
                <h1 className="font-extrabold"> End of studies intership</h1>
                <p>
                    {" "}
                    Developing and maintaining an E-commerce web application at
                    Medical <br />
                    and surgical suppliers using these technologies:
                </p>
